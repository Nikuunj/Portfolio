        ...
        >
          <div className="mt-14 max-[455px]:mt-6 text-lg">
            ...
            <div className="flex flex-row gap-4 mt-4 justify-center items-center">
              <a href="https://www.linkedin.com/in/makwana-nikunj/">
                <img
                  alt="info"
              ...
              <a href="https://github.com/Nikuunj">
                <img
                  alt="info"
                  className="w-10 max-[992px]:w-7 max-[455px]:w-5"
                  src={img1}
              ...
              <a href="https://x.com/nikunj__makwana">
                <img
                  alt="info"
                  className="w-10 max-[992px]:w-7 max-[455px]:w-5"
                  src={img3}
              ...
              <a href="https://leetcode.com/u/Nikunj_Makwana/">
                <img
                  alt="info"
